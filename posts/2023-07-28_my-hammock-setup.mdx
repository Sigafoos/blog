...
I like hammock camping. It's much more comfortable for my neck/back than sleeping on the ground with a sleeping pad, though admittedly that may be because I don't have a comfortable pillow that works with that (compared to the same pillow which works great in a hammock).
...
I also haven't extensively compared options: I have a setup that works, and I'm not going to buy new things just because. I doscovered Onewind when looking for a cheap underquilt and have been happy with their stuff, so most of my gear is from them. There are two main things I dislike about them, both website-based:
...
My least favorite part are the cinch buckles that attach to the tree straps. Having to completely undo a strap if you forgot to attach something that slides over the hammock is frustrating, though that's probably only the wind sock (since you won't need a bug net). They work fine, but I'd like to explore other options.
...
A Onewind underquilt/top quilt combo. I'm not sure [which one](https://www.onewindoutdoors.com/collections/under-quilts) I bought: probably the [4 season](https://www.onewindoutdoors.com/products/hammock-underquilt-4-season-od-green) one (but in blue)? I bought it in December 2021, and when I got one for my son in December 2022 I either got the wrong one or they changed it, because they came in smaller individual stuff sacks instead of one slightly larger one. It still works, but is slightly less convenient as I attach my single sack to the straps at the bottom of my pack.

This is great. In the winter I attach the two together with the built in snaps and use a 0&deg; sleeping bag as a top quilt. I've done two Klondikes with my troop with this setup: the first got as low as 5&deg; and I was still nice and toasty. In the other three seasons I unsnap the two and have an underquilt and blanket in one package.

When I got the set for my son the blanket and UQ had snaps that didn't line up. I contacted support and they verified which one he should have and sent it to us, telling me to keep the "wrong" one. I use that as a blanket if I ever have to slum it in a tent and it works great.
...
* attach the corners on each side together, allowing air to flow through; easy entry; and a more traditional "stake each corner out" setup
* attach the corners on opposite sides together to make "doors": this creates a totally enclosed area
* "porch mode": loosen both stake outs on one side and prop up with trekking poles

On Memorial Day we had people over and I set it up sans-hammock in porch mode for more shade.

If you have it high enough then when you have doors on both side and close them then you can stand up and change in privacy, the lack of which is one of the bigger downsides to hammock camping.
...
It was a little claustrophobic in there, because by its nature you won't be staking it out or anything. But for winter camping I'll take being snug in my little cocoon at night.

There's one end that's latger than the other: it took me a bit to realize that lets me slide my hammock/UQ out and have easier access during the day, then redeploy the sock at night. That wouldn't work with a gear hammock, though.
